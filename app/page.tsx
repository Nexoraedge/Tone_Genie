      ...
      <div className="purple-glow"></div>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            ><Link target="_blank" className="text-xl flex items-center w-full justify-center gap-3 px-12 py-4 rounded-xl  shadow-lg" href="https://github.com/Nexoraedge/Text_Enhancer?tab=readme-ov-file#-quick-install">
